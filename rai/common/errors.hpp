...
enum class ErrorCode : int
{
    ...
    TOKEN_UNMAP_MORE_THAN_BALANCE       = 882,
    TOKEN_WRAP_TO_INVALID_CHAIN         = 883,
    TOKEN_WRAP_TO_UNSUPPORTED_CHAIN     = 884,
    TOKEN_WRAP_TO_UNKNOWN_CHAIN         = 885,
    TOKEN_CROSS_CHAIN_REQUEST_TIMEOUT   = 886,
    TOKEN_CROSS_CHAIN_RESPONSE_JSON     = 887,
    TOKEN_CROSS_CHAIN_REQUEST_ID        = 888,
    TOKEN_CROSS_CHAIN_RESPONSE_ERROR    = 889,
    TOKEN_CROSS_CHAIN_UNEXPECTED        = 890,
    TOKEN_CROSS_CHAIN_QUORUM            = 891,
    TOKEN_CROSS_CHAIN_BLOCK_HEIGHT      = 892,
    TOKEN_CROSS_CHAIN_SESSION_ID        = 893,
    TOKEN_CROSS_CHAIN_INVALID_CHAIN     = 894,
    TOKEN_CROSS_CHAIN_INVALID_HEIGHT    = 895,
    ...
    JSON_CONFIG_CROSS_CHAIN_INVALID_ENDPOINT        = 1101,
    JSON_CONFIG_CROSS_CHAIN_NO_ENOUGH_ENDPOINTS     = 1102,
    JSON_CONFIG_CROSS_CHAIN_ETH_TEST_GOERLI         = 1103,
    JSON_CONFIG_CROSS_CHAIN_BSC_TEST                = 1104,
    JSON_CONFIG_CROSS_CHAIN_ETH                     = 1105,
    JSON_CONFIG_CROSS_CHAIN_BSC                     = 1106,
