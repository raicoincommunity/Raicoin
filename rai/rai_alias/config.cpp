...
rai::AliasConfig::AliasConfig()
    : rpc_enable_(true),
      rpc_{boost::asio::ip::address_v4::any(),
           rai::AliasConfig::DEFAULT_RPC_PORT,
           false,
           {boost::asio::ip::address_v4::loopback()}},
      app_(rai::AliasConfig::DEFAULT_WS_PORT)
{
}

rai::ErrorCode rai::AliasConfig::DeserializeJson(bool& upgraded,
                                                 rai::Ptree& ptree)
{
    if (ptree.empty())
    {
...
void rai::AliasConfig::SerializeJson(rai::Ptree& ptree) const
{
    ptree.put("version", "1");
...
rai::ErrorCode rai::AliasConfig::UpgradeJson(bool& upgraded, uint32_t version,
